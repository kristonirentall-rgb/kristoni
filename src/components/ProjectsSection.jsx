...
import tables3 from '../assets/tables3.jpg';
...
import electronics3 from '../assets/electronics3.jpg';
...
export const sectors = [
  ...
  },
  {
    ...
    pricing: "$15 per table/day",
    availability: "200 units available",
  },
  {
    id: 4,
    sector: "Event Rentals",
    title: "Audio Equipment",
    description: "Professional PA systems with microphones, speakers, and mixers for events up to 500 people.",
  ...
  },
  {
    ...
    description: "Premium kitchenware, bedding, and home organization products at competitive prices.",
  ...
  },
  {
    ...
    description: "Affordable gadgets, headphones, and smart home devices with 1-year warranty.",
    images: [electronics1, electronics2, electronics3],
    tags: ["Tech", "Gadgets", "Smart"],
    demoUrl: "#",
    colorClass: "bg-purple-100 text-purple-800",
    specifications: {
      products: "Headphones, smart plugs, cameras",
      features: ["1-year warranty", "Bluetooth 5.0", "App-controlled"],
    },
    pricing: "From $15 to $200",
    availability: "In stock",
  },
  {
    id: 8,
    ...
    description: "Fresh, pesticide-free vegetables and fruits delivered weekly from local farms.",
  ...
  },
  {
    ...
    description: "Free-range chickens and eggs from our ethically-raised flocks.",
  ...
  },
  {
    ...
    description: "Tractors, tillers, and irrigation systems for commercial farming operations.",
  ...
  },
  {
    ...
    description: "Hands-on courses in construction, automotive repair, and electrical work.",
  ...
  },
  {
    ...
    description: "Beginner to advanced computer classes for all age groups.",
  ...
  },
  {
    ...
    description: "Advanced greenhouse solutions for year-round crop production with climate control.",
  ...
  },
  {
    ...
    description: "Complete hydroponic systems for soil-less farming, ideal for urban and commercial growers.",
